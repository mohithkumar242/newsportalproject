                ...
                <div class="row">
                    <div class="col-sm-12" >
                        ...
                        <div class="wrapper-page" >
                            ...
                            <div class="m-t-40 account-pages" style="background-color: #17a2b8;" >
                                <div class="text-center account-logo-box" style="background-color: #ff577f;">
                                    <h2 class="text-uppercase">
                                        <a href="index.html" class="text-success">
                                            <span><img style="border-radius: 25px;" src="assets/images/logo1.jpg" alt="" height="56"></span>
                                        </a>
                                    </h2>
